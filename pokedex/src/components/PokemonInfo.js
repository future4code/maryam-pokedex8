...
import { PokePic, PokeInfoContainer, ButtonsCard, DivImage, DivTypes } from "./styles";
...
const PokemonInfo = (props) => {
    ...
    return (
        ...
        <Card sx={{ width: 220 }}>
            ...
            <Typography sx={{fontSize: 16, fontWeight: 600}} >{props.poke.name.toUpperCase()}</Typography>
            ...
            <Button
                size="small"
                variant="outlined"
                onClick={() => goToDetailsPage(props.poke.name)}
            >
                Detalhes
            </Button>
            </ButtonsCard>
